...
public class CubridTriggerManager extends SQLTriggerManager<CubridTrigger, GenericTableBase> {
	...
	@Override
	public DBSObjectCache<? extends DBSObject, CubridTrigger> getObjectsCache(CubridTrigger object) {
    ...
    protected void createOrReplaceTriggerQuery(
        ...
        if (create) {
            ...
            if (trigger.getEvent().equals("COMMIT") || trigger.getEvent().equals("ROLLBACK")) {
                ...
                sb.append(trigger.getEvent());
                sb.append(" ON ").append(trigger.getTable());
...
//        if (trigger.isPersisted() && command.hasProperty("owner")) {
//            actions.add(
//                    new SQLDatabasePersistAction(
//                            "Change Owner",
//                            "ALTER TRIGGER " + trigger.getFullyQualifiedName(DBPEvaluationContext.DDL) + " OWNER TO " + trigger.getOwner()));
//        }
//    }
}
